...
const ptComponents = {
  ...
  block: {
    h1: ({ children }: any) => <h1 className="text-4xl font-black mt-16 mb-6 text-zinc-900">{children}</h1>,
    h2: ({ children }: any) => <h2 className="text-3xl font-bold mt-12 mb-6 text-zinc-900">{children}</h2>,
    h3: ({ children }: any) => <h3 className="text-2xl font-bold mt-10 mb-5 text-zinc-800">{children}</h3>,
  ...
  if (!project) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-zinc-500 mb-8">The project you are looking for doesn't exist.</p>
        <Link
          href="/projects"
  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-12 md:py-20 mt-10">
      ...
      <header className="mb-12">
        <h1 className="text-5xl md:text-6xl font-black mb-6 leading-tight text-zinc-900">
          {project.name}
        </h1>
        ...
        {project.projectUrl && (
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-zinc-900 text-white rounded-full font-bold text-lg hover:bg-zinc-800 transition-all hover:scale-105 active:scale-95 shadow-xl shadow-zinc-900/20"
          >
            Visit Project
      ...
      <article className="max-w-3xl mx-auto">
        <div className="prose prose-zinc max-w-none prose-lg md:prose-xl">
          {project.description ? (
            ...
            <p className="text-zinc-500 italic">No description available for this project.</p>
          )}
        </div>
      </article>
    </main>
